          ...
          <div key={cat}>
            ...
            {cat === 'cards' && (
              !player.bestiaryUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>🃏 Tonight on Hoarders unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'coins' && (
              !prestige?.coinsTradedIn ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>💰 Health is Wealth unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'stamps' && (
              !prestige?.readyOrNotTreeUnlocked ? (
