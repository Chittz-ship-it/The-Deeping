...
export default function BlenderModelViewer({ src, label, size=220, compact=false, profile:providedProfile={}, fallback=null }) {
  ...
  },[sourceKey,compact,profile.primary,profile.secondary,profile.accent,profile.emissive,profile.ghostly,profile.toughened,profile.toxic,profile.bloodbound,profile.frosted,profile.fireWreathed,profile.arcaneCharged,profile.stormCharged,profile.crowned,profile.infrared,profile.iridescent,profile.ultraviolet,profile.metalness,profile.roughness,elementKey]);
