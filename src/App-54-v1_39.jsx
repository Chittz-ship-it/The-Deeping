...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'SELL': {
      ...
      else price = item.rarity === 'mythic' ? 400 : item.rarity === 'legendary' ? 250 : item.rarity === 'epic' ? 110 : item.rarity === 'rare' ? 50 : item.rarity === 'uncommon' ? 25 : 12;
...
function RarityTag({ rarity }) {
  const cls = rarity === 'mythic' ? 'dc-mythic' : rarity === 'legendary' ? 'dc-legendary' : rarity === 'epic' ? 'dc-epic' : rarity === 'rare' ? 'dc-rare' : rarity === 'uncommon' ? 'dc-uncommon' : 'dc-common';
  return (
...
function GearExamineOverlay({ item, onClose, onClean }) {
