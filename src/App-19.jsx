...
function freshPrestige() {
  return {
    ...
    coinsTradedIn: false,        // first coin set traded in (unlocks skill tiers V-X)
    coins2TreeUnlocked: false,   // second coin set traded in
    coins2Unlocked: [],          // array of COINS2_TREE ids
  };
}
...
function PrestigePanel({ prestige, onUnlock, onUnlockTrick, onUnlockReadyOrNotTier, onUnlockBetterMerchantTier, onUnlockCoins2Tier, onNewRun }) {
