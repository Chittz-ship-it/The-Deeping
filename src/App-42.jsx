...
function applyGiftedRelic(player, relicId) {
  ...
  if (relicId === 'heart_mountain') { p.maxHp += 20; p.hp += 20; }
  else if (relicId === 'berserker_tooth') { p.atk += 3; }
  else if (relicId === 'guardian_ward') { p.def += 3; }
  else if (relicId === 'ember_heart') { p.maxHp += 30; p.hp += 30; p.atk += 2; }
  return p;
}
          ...
          <div key={cat}>
            ...
            {cat === 'cards' && (
              !player.bestiaryUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>✨ Dimensional Gift unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'coins' && (
              !prestige?.coinsTradedIn ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>🧠 Meaningful Learner unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'stamps' && (
              !prestige?.readyOrNotTreeUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>📮 Self-Starter unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'figures' && (
              !prestige?.betterMerchantTreeUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>🛡️ Defensive Collecting unlocked. Keep collecting.</p>
              )
            )}
          </div>
        );
