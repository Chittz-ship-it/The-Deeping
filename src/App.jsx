  ...
  return (
    ...
    >
      <div onClick={(e) => e.stopPropagation()} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
        <ExamineRotatable>
          <EmojiSolid3D emoji={getGearEmoji(item)} rarityColor={rarityColor} filter={getGearFilter(item.rarity)} />
        </ExamineRotatable>
...
const BODY_SLOT_LAYOUT = [
  { key: 'earring',    top: '4%',  left: '33%' },
  { key: 'earring2',   top: '4%',  left: '67%' },
  { key: 'armor',      top: '27%', left: '50%' },
  { key: 'chestpiece', top: '43%', left: '50%' },
  { key: 'weapon',     top: '48%', left: '86%' },
  { key: 'ring1',      top: '58%', left: '13%' },
  { key: 'ring2',      top: '69%', left: '13%' },
  { key: 'ring3',      top: '80%', left: '13%' },
  { key: 'greaves',    top: '68%', left: '50%' },
  { key: 'footwear',   top: '91%', left: '50%' },
];
    ...
    <div style={{ position: 'relative', height: 300, marginBottom: 4 }}>
      <div
        style={{
          ...
          fontSize: 180, opacity: 0.12, color: '#e8a23d', pointerEvents: 'none', userSelect: 'none',
        }}
      >
        🧍
      </div>
    ...
    <div>
      ...
      {known.length === 0 ? (
        ...
        <div className="dc-panel-raised rounded p-3">
          ...
          <div className="flex items-center gap-2 mb-2">
            <span className="text-2xl">{selectedEnemy.emoji}</span>
            <div>
