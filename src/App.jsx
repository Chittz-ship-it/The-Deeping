...
function generateMerchantStock(depth, player) {
  ...
  const weighted = moreSkillbooks
    ? [...commonSkillbookPool, ...commonSkillbookPool, ...commonSkillbookPool, ...rareSkillbookPool, ...rareSkillbookPool, ...rarePool, ...epicPool]
    ...
    case 'FIRE_BOW': {
      ...
      if (action.type === 'THROW') {
        if (player.throwable && player.throwable.autoKill) {
          ...
          throwBaseAtk = baseAtk + (player.knifeDmgBonus || 0);
          const critRoll = Math.random() * 100 < (player.knifeCritChance || 0);
...
function PrestigePanel({ prestige, onUnlock, onUnlockTrick, onUnlockReadyOrNotTier, onUnlockBetterMerchantTier, onUnlockCoins2Tier, onUnlockMadgodTier, onUnlockPhysicianTier, onNewRun }) {
          ...
          <div key={cat}>
            ...
            {cat === 'coins' && (
              !prestige?.coinsTradedIn ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>🪙 Blade Mastery already unlocked. Keep collecting for future bonuses.</p>
              )
            )}
            {cat === 'stamps' && (
              !prestige?.readyOrNotTreeUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>📮 Physician Heal Thyself already unlocked. Keep collecting.</p>
              )
            )}
            {cat === 'figures' && (
              !prestige?.betterMerchantTreeUnlocked ? (
                ...
                <p className="text-[11px]" style={{ color: '#9a9788' }}>🤖 Luck of the Madgod already unlocked. Keep collecting.</p>
              )
            )}
          </div>
        );
